        ...
        <div class="flex h-16 items-center justify-between">
            <div class="flex items-center">
                <div class="flex-shrink-0">
                    {{-- <img class="h-8 w-8" src="public\images\1009828.jpg"
                        alt="Your Company"> --}}
                </div>
                ...
                <div class="ml-4 flex items-center md:ml-6">
                    @if (Route::has('login'))
                        @auth
                            ...
                            <a href="{{ route('admin.dashboard') }}" class="bg-white-400 text-black py-2 px-6 rounded-md">Admin Dashboard</a>
                            @endif
                            <!-- Profile dropdown -->
                        ...
                        @else
                            <a href="{{ route('login') }}"
                                class="rounded-md px-3 py-2 text-gray-300 ring-1 ring-transparent transition hover:text-black/70 focus:outline-none focus-visible:ring-[#FF2D20] dark:text-white dark:hover:text-white/80 dark:focus-visible:ring-white">
                                Log in
                            </a>
...
{{-- <div x-show="isOpen" class="md:hidden" id="mobile-menu">
    <div class="space-y-1 px-2 pb-3 pt-2 sm:px-3">
        ...
        <x-nav-link-active href="/" :active="request()->is('/')">Home</x-nav-link-active>
        <x-nav-link-active href="/skill" :active="request()->is('skill')">Skill</x-nav-link-active>
        <x-nav-link-active href="/projek" :active="request()->is('projek')">Projek</x-nav-link-active>
        <x-nav-link-active href="/certificate" :active="request()->is('certificate')">Certificate</x-nav-link-active>
        <x-nav-link-active href="/about" :active="request()->is('about')">About</x-nav-link-active>
        <x-nav-link-active href="/contact" :active="request()->is('contact')">Contact</x-nav-link-active>
    </div>
    <div class="border-t border-gray-700 pb-3 pt-4">
        <div class="flex items-center px-5">
            ...
            <div class="ml-3">
                <div class="text-base font-medium leading-none text-white">Milki Dwi Putra</div>
                <div class="text-sm font-medium leading-none text-gray-400">milki@gmail.com</div>
            </div>
        </div>
